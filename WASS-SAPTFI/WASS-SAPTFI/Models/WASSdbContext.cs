...
namespace WASS_SAPTFI.Models
{
    public class WASSdbContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<WASS_SAPTFI.Models.WASSdbContext>());

        public WASSdbContext() : base("name=WASSdbContext")
        {
        }
